<div class="min-h-screen px-3 py-4 overflow-y-auto bg-gray-800">
    <ul class="space-y-2 font-medium">
        ...
        <li>
            ...
            <ul id="dropdown-users" class="hidden py-2 space-y-2">
                ...
                <li>
                    <a href="#"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Chefs</a>
                </li>
            </ul>
        </li>
            ...
            <ul id="dropdown-settings" class="hidden py-2 space-y-2">
                <li>
                    <a href="{{route('admin.cuisine.list')}}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Cuisines</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{route('admin.includes.list')}}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Service Includes</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.requirement.list')}}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Menu Requirements</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{route('admin.perk.list')}}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Perks</span>
                    </a>
                </li>
            </ul>
        </li>
