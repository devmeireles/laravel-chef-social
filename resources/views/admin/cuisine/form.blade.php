<x-admin-layout>
    <div class="flex flex-col">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{route('admin.cuisine.list')}}"
                                class="ml-1 text-sm font-medium text-gray-800 hover:text-blue-600 md:ml-2">Cuisines</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
        ...
        <div class="w-100 mt-12 block p-6 bg-white border border-gray-200 rounded-lg">
            <form method="post"
                action="{{isset($item) ? route('admin.cuisine.update', $item->id) : route('admin.cuisine.store')}}">
                @csrf

                <div class="w-8/12">
                    <div class="mb-6">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Cuisine Name</label>
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="The Cuisine name" value="{{!empty($item->name) ? $item->name : old('name')}}">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" rows="4" name="description"
                            ...
                            placeholder="A short description about the cuisine">{{!empty($item->description) ? $item->description : old('description')}}</textarea>
                ...
                <div class="w-8/12 flex mt-14">
                    ...
                    @if(isset($item) && $item->deleted_at)
                    <a href="{{route('admin.cuisine.reactivate', $item->id)}}"
    ...
    <div id="popup-modal" tabindex="-1"
        ...
        <form method="post" action="{{route('admin.cuisine.destroy', $item->id)}}">
            @method('delete')
            @csrf
