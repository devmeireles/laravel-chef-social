<x-admin-layout>
    <div class="flex flex-col">
        ...
        <div class="w-100 mt-12 block p-6 bg-white border border-gray-200 rounded-lg">
            <form method="post"
                action="{{isset($item) ? route('admin.tag.update', $item->id) : route('admin.tag.store')}}">
                @csrf
                ...
                <div class="w-8/12">
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="The Tag name" value="{{!empty($item->name) ? $item->name : old('name')}}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="slug" name="slug"
                            class="bg-stone-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="The Tag name" readonly value="{{!empty($item->slug) ? $item->slug : old('slug')}}">
                ...
                <div class="w-8/12 flex mt-14">
                    ...
                    @if(isset($item) && $item->deleted_at)
                    <a href="{{route('admin.tag.reactivate', $item->id)}}"
